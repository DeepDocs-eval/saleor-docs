...
[`checkoutShippingMethodUpdate`](/api-reference/checkout/mutations/checkout-shipping-method-update.mdx) <Badge class="badge badge--secondary badge--relation" text="mutation"/>
